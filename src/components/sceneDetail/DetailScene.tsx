...
export type DetailSceneType = ParentProps & {
...
const DetailScene: Component<DetailSceneType> = (props: DetailSceneType) => {
  return (
    <div class={DetailSceneClass}>
